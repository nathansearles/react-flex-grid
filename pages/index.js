          ...
          <Container>
            <Row>
              <Column columns={{ xs: 12 }}>
                <h1 className={styles.title}>React Flex Grid</h1>
            ...
            <Row>
              <Column columns={{ xs: 12, md: 6 }}>
                ...
                <p>
                  ...
                  space. That also means you can set the width of one item and
          ...
          <Container>
            <Row>
              <Column columns={{ xs: 12, md: 6 }}>
                <h2>Spacing</h2>
                <p>
                  Default spacing is 0.5rem or 8px. Enter number between 0 and
                  4. 8px * spacing.
                </p>
              </Column>
            </Row>
